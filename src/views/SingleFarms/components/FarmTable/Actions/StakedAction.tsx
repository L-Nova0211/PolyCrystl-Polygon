...
const Staked: React.FunctionComponent<StackedActionProps> = ({
  ...
  const displayBalance = useCallback(() => {
    return getDisplayBalanceAdjustable(stakedBalance, isMobile, token.decimals)
  }, [stakedBalance, isMobile, token])
            ...
            <div>
              ...
              {stakedBalance.gt(0) && lpPrice.gt(0) && (
                <Balance
                  ...
                  color="textSubtle"
                  decimals={2}
                  value={getBalanceNumber(new BigNumber(token.busdPrice).times(stakedBalance), token.decimals)}
                  unit=" USD"
                  prefix="~"
                />
              )}
  ...
  return (
    <ActionContainer>
      <ActionTitles>
        <Subtle>{t('Enable Token').toUpperCase()}</Subtle>
      </ActionTitles>
      <ActionContent>
