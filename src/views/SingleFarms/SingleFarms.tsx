...
import { RowType, Toggle, Text, JewelsLogo } from '@crystals/uikit'
    ...
    (farmsToDisplay: Farm[]): FarmWithStakedValue[] => {
      let farmsToDisplayWithAPR: FarmWithStakedValue[] = farmsToDisplay.map((farm) => {
        ...
        const totalLiquidity = new BigNumber(
          getBalanceNumber(new BigNumber(farm.tokensInContract), farm.quoteToken.decimals),
        ).times(farm.quoteToken.busdPrice)
      ...
      <ControlContainer>
        ...
        <FilterContainer>
          ...
          <LabelWrapper style={{ marginLeft: 16 }}>
            ...
            <SearchInput onChange={handleChangeQuery} placeholder="Search Jewels" />
          </LabelWrapper>
        </FilterContainer>
      </ControlContainer>
      {renderContent()}
