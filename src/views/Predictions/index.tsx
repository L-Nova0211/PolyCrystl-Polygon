...
import { useMatchBreakpoints, useModal } from '@crystals/uikit'
...
const Predictions = () => {
  ...
  const [hasAcceptedRisk, setHasAcceptedRisk] = usePersistState(false, {
    localStorageKey: 'polycrystal_predictions_accepted_risk',
  })
  const [hasAcceptedChart, setHasAcceptedChart] = usePersistState(false, {
    localStorageKey: 'polycrystal_predictions_chart',
  })
