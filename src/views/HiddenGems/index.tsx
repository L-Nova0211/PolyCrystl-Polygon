...
import { GemsLogo, Flex, Text, useModal } from '@crystals/uikit'
...
import BountyCard from '../Pools/components/BountyCard'
...
const HiddenGems: React.FC = () => {
  ...
  const [hasAcceptedRisk, setHasAcceptedRisk] = usePersistState(false, {
    localStorageKey: 'polycrystal_hidden_gems_accepted_risk',
  })
  ...
  const pools = useMemo(() => {
    const gemPools = poolsWithoutAutoVault.filter((pool) => pool.gemPool)
    return gemPools
