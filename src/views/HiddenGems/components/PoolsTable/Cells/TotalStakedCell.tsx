...
import { Flex, Skeleton, Text } from '@crystals/uikit'
...
const TotalStakedCell: React.FC<TotalStakedCellProps> = ({ pool }) => {
  ...
  const { totalCrystlInVault } = useCrystlVault()
  ...
  }, [isAutoVault, totalCrystlInVault, isManualCrystlPool, totalStaked, stakingToken.decimals])
