...
import { Heading, CardBody, CardFooter, PancakeRoundIcon, TicketRound } from '@crystals/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading valueToDisplay={`${poolSize.toLocaleString()} CRYSTL`} Icon={PancakeRoundIcon}>
              {t('Total prizes')}
            </LotteryCardHeading>
          </CardHeading>
        </CardBody>
