...
import { PERFORMANCE_FEE } from 'config'
      ...
      <Flex justifyContent="stretch">
        <Box mb="28px" maxWidth="340px">
          <Text fontSize="12px" textAlign="center" color="textSubtle">
            {t(
              'Calculated based on current rates. Compounding at an optimal rate. Rates are estimates provided for your convenience only, and by no means represent guaranteed returns.',
            )}
          </Text>
          {performanceFee > 0 && (
