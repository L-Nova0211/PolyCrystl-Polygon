...
import { Button, Flex, Heading, useModal, Won } from '@crystals/uikit'
import { useProfile } from 'state/hooks'
import { useTranslation } from 'contexts/Localization'
import ClaimNftAndCrystlModal, { useCanClaim } from './ClaimGiftModal'
...
const ProfileHeader = () => {
  ...
  const [onPresentClaimGiftModal] = useModal(<ClaimNftAndCrystlModal onSuccess={checkClaimStatus} />)
